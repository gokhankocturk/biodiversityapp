...
Latest version of the application can be downloaded from [Github](https://github.com/) using the following command:
...
1. Biodiversity app is deployed on "shinyapps.io" platform and available at [here](https://gokhankocturk.shinyapps.io/biodiversityapp_appsilon/)\
...
## test-data_for_map.R
**Explanation**\
Users can search species by their scientific and vernacular name typing in **searchInput**  field and selecting matched name from **selectInput** field in biodiversityapp. You can search by typing either full name or a substring. If correct match exists, the data
is created for map.\
